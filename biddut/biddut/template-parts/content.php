...
$tag_col_number= $biddut_social_share_switch ? "col-xl-7 col-lg-6 col-md-6" : "col-12";
...
<article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item format-image mb-50 transition-3 format-standard' );?>>
  <?php if(has_post_thumbnail()) : ?>  
