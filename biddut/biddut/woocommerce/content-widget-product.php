	...
	<div class="tp-shop-widget-product-item d-flex align-items-center">
		...
		<div class="tp-shop-widget-product-content">
			...
			<div class="tp-shop-widget-product-price-wrapper">
				<span class="tp-shop-widget-product-price"><?php echo wp_kses_post($product->get_price_html()); // PHPCS:Ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
			</div>
		</div>
	</div>
